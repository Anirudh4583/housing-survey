# Read csv file
library(readxl)
feedback <- read_excel("housing_survey_responses.xlsx")
...
mylevels <- factor(c("Very Interested", "Somewhat Interested", "Not Interested", "None"))
#subset data for issues only
feedbackwork <- feedback[c(9:18)]
feedbackwork <- as.data.frame(feedbackwork)

for(i in seq_along(feedbackwork)) {
  feedbackwork[,i] <- factor(feedbackwork[,i], levels=mylevels)
}

feed <-likert(feedbackwork)
...
mylevels1 <- factor(c("Very Concerned", "Somewhat Concerned", "Not Concerned", "None"))

#subset housing concern data only
feedbackcon <- feedback[c(2:7)]
feedbackcon <- as.data.frame(feedbackcon)
for(i in seq_along(feedbackcon)) {
  feedbackcon[,i] <- factor(feedbackcon[,i], levels=mylevels1)
}

feed1 <-likert(feedbackcon) 
...
feedback4 <- feedback[c(24,27)]

library(dplyr)
feedbackgroup <- group_by(feedback4, Zip_Code, Cost_burdened)
...
feedbackcostb <- subset(feedback, Cost_burdened == "Yes")
feedbackcostb1 <- feedbackcostb[c(9:18)]
mytitle2 <- "How interested are you in learning more about the following issues? burdened"
mylevels2 <- factor(c("Very interested", "Somewhat Interested", "Not Interested", "None"))
feedbackcostb1 <- as.data.frame(feedbackcostb1)
for(i in seq_along(feedbackcostb1)) {
  feedbackcostb1[,i] <- factor(feedbackcostb1[,i], levels=mylevels2)
}
feedcostb <-likert(feedbackcostb1) 
#plot issues only
scale_height = knitr::opts_chunk$get('fig.height')*0.5
scale_width = knitr::opts_chunk$get('fig.width')*1.25
knitr::opts_chunk$set(fig.height = scale_height, fig.width = scale_width)
...
feedbackcostnb <- subset(feedback, Cost_burdened == "No")
feedbackcostnb1 <- feedbackcostnb[c(9:18)]
mytitle3 <- "How interested are you in learning more about the following issues?nburdened"
mylevels3 <- factor(c("Very Interested", "Somewhat Interested", "Not Interested", "None"))
feedbackcostnb1 <- as.data.frame(feedbackcostnb1)
for(i in seq_along(feedbackcostnb1)) {
  feedbackcostnb1[,i] <- factor(feedbackcostnb1[,i], levels=mylevels3)
}
feedcostnb <-likert(feedbackcostnb1) 
#plot issues only
scale_height = knitr::opts_chunk$get('fig.height')*0.5
scale_width = knitr::opts_chunk$get('fig.width')*1.25
knitr::opts_chunk$set(fig.height = scale_height, fig.width = scale_width)
...
#subset maybe and check interest
feedbackcostna <- subset(feedback, Cost_burdened == "Maybe")
feedbackcostna1 <- feedbackcostna[c(9:18)]
mytitle4 <- "How interested are you in learning more about the following issues?napply"
mylevels4 <- factor(c("Very Interested", "Somewhat Interested", "Not Interested", "None"))
feedbackcostna1 <- as.data.frame(feedbackcostna1)
for(i in seq_along(feedbackcostna1)) {
  feedbackcostna1[,i] <- factor(feedbackcostna1[,i], levels=mylevels4)
}
feedcostna <-likert(feedbackcostna1) 
#plot issues only
scale_height = knitr::opts_chunk$get('fig.height')*0.5
scale_width = knitr::opts_chunk$get('fig.width')*1.25
knitr::opts_chunk$set(fig.height = scale_height, fig.width = scale_width)
...
feedbackconnb <- subset(feedback, Cost_burdened == "No")
feedbackconnb1 <- feedbackconnb[c(2:7)]

mytitle5 <- "What are your biggest housing Concerns? nburdened"
mylevels5 <- factor(c("Very Concerned", "Somewhat Concerned", "Not Concerned", "None"))
feedbackconnb1 <- as.data.frame(feedbackconnb1)
for(i in seq_along(feedbackconnb1)) {
  feedbackconnb1[,i] <- factor(feedbackconnb1[,i], levels=mylevels5)
}
feedconnb <-likert(feedbackconnb1) 
#plot issues only
scale_height = knitr::opts_chunk$get('fig.height')*0.5
scale_width = knitr::opts_chunk$get('fig.width')*1.25
knitr::opts_chunk$set(fig.height = scale_height, fig.width = scale_width)
...
feedbackconb <- subset(feedback, Cost_burdened == "Yes")
feedbackconb1 <- feedbackconb[c(2:7)]

mytitle6 <- "What are your biggest housing Concerns? burdened"
mylevels6 <- factor(c("Very Concerned", "Somewhat Concerned", "Not Concerned", "None"))
feedbackconb1 <- as.data.frame(feedbackconb1)
for(i in seq_along(feedbackconb1)) {
  feedbackconb1[,i] <- factor(feedbackconb1[,i], levels=mylevels6)
}
feedconb <-likert(feedbackconb1) 
#plot issues only
scale_height = knitr::opts_chunk$get('fig.height')*0.5
scale_width = knitr::opts_chunk$get('fig.width')*1.25
knitr::opts_chunk$set(fig.height = scale_height, fig.width = scale_width)
...
feedbackcona <- subset(feedback, Cost_burdened == "Maybe")
feedbackcona1 <- feedbackcona[c(2:7)]

mytitle7 <- "What are your biggest housing Concerns? maybe"
mylevels7 <- factor(c("Very Concerned", "Somewhat Concerned", "Not Concerned", "None"))
feedbackcona1 <- as.data.frame(feedbackcona1)
for(i in seq_along(feedbackcona1)) {
  feedbackcona1[,i] <- factor(feedbackcona1[,i], levels=mylevels7)
}
feedcona <-likert(feedbackcona1) 
#plot issues only
scale_height = knitr::opts_chunk$get('fig.height')*0.5
scale_width = knitr::opts_chunk$get('fig.width')*1.25
knitr::opts_chunk$set(fig.height = scale_height, fig.width = scale_width)
...
feedbackenv1 <- feedbackenv[c(2:7)]

mytitle8 <- "What are your biggest housing Concerns?very interested in env"
mylevels8 <- factor(c("Very Concerned", "Somewhat Concerned", "Not Concerned", "None"))
feedbackenv1 <- as.data.frame(feedbackenv1)
for(i in seq_along(feedbackenv1)) {
  feedbackenv1[,i] <- factor(feedbackenv1[,i], levels=mylevels8)
}
feedenv <-likert(feedbackenv1) 
#plot issues only
scale_height = knitr::opts_chunk$get('fig.height')*0.5
scale_width = knitr::opts_chunk$get('fig.width')*1.25
knitr::opts_chunk$set(fig.height = scale_height, fig.width = scale_width)
